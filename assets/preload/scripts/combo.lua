...
local foreverCount = true       -- Shows combo number like forever engine 
local countMisses  = true       -- Show the amount of misses each miss (Like Forever Engine)
...
OPPONENT = {
    ...
    colorRatings   = true,  -- Colors based on which rating you get
